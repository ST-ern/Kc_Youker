...
public class CardHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ImageButton card_delete, card_enter;
    ...
    public CardHolder(@NonNull View itemView) {
        ...
        this.card_delete=(ImageButton)itemView.findViewById(R.id.btn_delete_card);
        this.card_enter=(ImageButton)itemView.findViewById(R.id.btn_enter_card);
